	...
	<form class="login-form" action="LoginPost" controller="Accountcontroller" method="post">
		<div class="card mb-0">
			<div class="card-body">
				...
				<span class="form-text text-center text-muted">{{i18n .Lang "LoginTandC1"}} <a href="https://github.com/borowszky/PaystackInterviewTest">{{i18n .Lang "LoginTandC2"}}</a> {{i18n .Lang "LoginTandC3"}} <a href="https://github.com/borowszky/PaystackInterviewTest">{{i18n .Lang "LoginTandC4"}}</a></span>
			</div>
		</div>
	</form>
	<!-- /login card -->
